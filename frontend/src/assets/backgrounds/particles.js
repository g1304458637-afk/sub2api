// Artwork adapted from the user-supplied Anchor AI reference.
// Three.js: Copyright 2010-2025 Three.js Authors, SPDX-License-Identifier: MIT
...
return {
  ...
  dispose() {
    ...
    Ra.dispose(); Sn.dispose(); Sn.forceContextLoss();
  }
};
}
