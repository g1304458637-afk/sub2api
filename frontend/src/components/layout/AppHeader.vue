      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        >
          ...
          <button
            ...
            type="button"
            data-testid="header-currency-toggle"
            class="rounded-md px-1.5 py-0.5 text-xs font-semibold text-primary-600 ring-1 ring-primary-200 transition-colors hover:bg-primary-100 dark:text-primary-300 dark:ring-primary-800 dark:hover:bg-primary-900/40"
