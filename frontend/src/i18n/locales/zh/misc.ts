export default {
  ...
  payment: {
    ...
    admin: {
      ...
      userBalance: '用户余额',
      orderAmount: '订单金额',
      insufficientBalance: '余额不足，无法完成扣款',
  ...
  pricing: {
    ...
    statusStrip: {
      ...
      lastPlan: '上次套餐：{plan}',
      lastExpires: '有效期至',
      renewDefault: '下次续费默认：{plan}',
      renewNow: '续费 {plan}',
      chooseOther: '选择其他套餐',
      nextRenewalPlan: '下次续费套餐：{plan}',
      cancelChange: '取消变更',
    ...
    purchaseModal: {
      ...
      plan: '套餐',
      price: '套餐价格',
      note: '支付完成后套餐立即生效，可在「我的订阅」中查看周期与用量。',
      confirm: '去支付',
    },
    upgradeModal: {
      title: '升级确认',
