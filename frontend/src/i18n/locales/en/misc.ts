export default {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to MUC AI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">MUC AI is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of MUC AI, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to MUC AI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the MUC AI AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    admin: {
      ...
      month: 'months',
      tierRank: 'Tier rank',
      tierRankHint: 'Entitlement tier (0 = unset; unrelated to display order)',
      pcUser: 'User',
      pcType: 'Type',
      pcTier: 'Tier',
      pcAmount: 'Amount',
      pcStatus: 'Status',
      financeChangesTotal: '{total} records',
      financeChangesEmpty: 'No plan changes',
      financeChangesNote: 'Shows plan-change payment orders. Scheduled downgrades are not payment orders; their admin audit endpoint is pending (see FRONTEND_BLOCKED_BY_API #3).',
      financeLedgerNote: 'The global wallet ledger endpoint is pending (BLOCKED #1); query per-user recharge history for now. Reward/PAYG entries await a unified ledger.',
      ledgerUserId: 'User ID',
      ledgerEmpty: 'No recharge history for this user',
      ledgerFailed: 'Query failed',
      tabs: {
        overview: 'Overview',
        orders: 'Orders',
        channels: 'Channels',
  ...
  pricing: {
    ...
    reset: {
      ...
      overlayLabel: 'Quota restoration',
      periodStarted: 'New cycle started · next reset {date}',
      remainingCards: 'Reset cards left: {count}',
    },
    ...
    cta: {
      ...
      downgrade: 'Switch at renewal',
      scheduled: 'Set as next renewal plan',
      current: 'Current plan',
      unavailable: 'Unavailable',
    },
    fallbackFeatures: {
      basic: 'Core AI access|Weekly subscription quota|MUCODE supported|Pay-as-you-go with wallet|Use across devices',
      pro: 'Everything in Basic|Higher weekly quota|More advanced model access|Keep going after quota with wallet',
      max: 'Everything in Pro|Top-tier subscription benefits|Advanced model access|Priority user benefits',
    },
    ...
    statusStrip: {
      ...
      noActiveNow: 'No active plan',
      lastPlan: 'Last plan: {plan}',
      lastExpires: 'Valid until',
      renewDefault: 'Next renewal default: {plan}',
      renewNow: 'Renew {plan}',
      chooseOther: 'Choose another plan',
      nextRenewalPlan: 'Next renewal plan: {plan}',
    ...
    scheduledBanner: {
      on: 'Set as next renewal plan: {plan}',
      at: 'Current plan valid until {date}',
    ...
    purchaseModal: {
      ...
      plan: 'Plan',
      price: 'Plan price',
      note: 'The plan takes effect immediately after payment. Manage cycles and usage under "My Subscriptions".',
      confirm: 'Pay',
    },
    upgradeModal: {
      title: 'Confirm upgrade',
      quoteLoading: 'Fetching server quote…',
      quoteError: 'Failed to fetch quote, please retry',
      from: 'Current',
      to: 'Upgrade to',
      amountDue: 'Amount due',
      unusedCredit: 'Unused credit',
      proratedCharge: 'Remaining term on new tier',
      effectiveNow: 'Effective immediately — expiry stays {date}',
      usageShift: 'Weekly usage {before}% → {after}%',
      usageAfter: 'Weekly usage after upgrade ≈ {after}%',
      inheritKeys: 'Your existing API keys inherit the new plan automatically — no MUCODE reconfiguration needed',
      keysMigrate: '{count} API key(s) will migrate to the new group — key IDs and secrets stay unchanged',
      payMethod: 'Payment method',
      noMethod: 'No payment method available',
      note: 'Amount is server-quoted and frozen for 30 minutes.',
      confirm: 'Pay',
      confirming: 'Creating order…',
      retry: 'Refetch quote',
    },
    downgrade: {
      title: 'Confirm switch at renewal',
      body: 'At expiry ({date}) your plan switches to "{plan}" with the new tier limits. Nothing is charged now and no difference is refunded.',
      confirm: 'Schedule switch',
      confirming: 'Scheduling…',
      cancelTitle: 'Cancel scheduled switch?',
      cancelBody: 'Your current plan "{plan}" will continue unchanged.',
      cancelConfirm: 'Cancel switch',
      scheduledToast: 'Switch scheduled',
      cancelledToast: 'Scheduled switch cancelled',
    },
    errors: {
      quoteExpired: 'Quote expired — refreshed for you',
      upgradeFailed: 'Failed to create upgrade order',
      scheduleFailed: 'Failed to schedule switch',
      cancelFailed: 'Failed to cancel scheduled switch',
      planUnavailable: 'Current subscription does not support this action',
    },
    empty: 'No plans available for sale',
    footerNote: 'Plans and entitlements are served live from the backend',
  },

  mySub: {
    title: 'My Subscription',
    subtitle: 'Your plan, quota cycle and renewal at a glance.',
    ...
    scheduledTo: 'Switches at renewal: {plan}',
    scheduledEffective: 'Effective {date} — current period unchanged',
    cancelPlan: 'Cancel plan',
    paygTitle: 'Keep going after quota',
    paygHint: 'When the weekly quota runs out, usage continues with pay-as-you-go charges from your wallet.',
    paygConfirmTitle: 'Enable "keep going after quota"?',
    paygConfirmBody: 'Current wallet balance: {wallet}. You will be charged automatically once the quota is exhausted.',
    paygConfirmOk: 'Enable',
    paygError: 'Action failed, please retry',
    resetCards: 'Reset cards · {count} available',
    resetHint: 'Using one resets this week\u2019s usage immediately and starts a fresh 7-day cycle from now.',
    useResetCard: 'Use reset card',
    resetConfirmTitle: 'Use a reset card?',
    resetConfirmBody: 'This immediately resets this week\u2019s usage ({count} left). Reset cards cannot be returned.',
    resetConfirmOk: 'Use card',
    resetError: 'Reset failed, please retry',
  ...
  wallet: {
    title: 'Wallet',
    subtitle: 'One account for top-ups, rewards and pay-as-you-go.',
    balance: 'Wallet balance',
    recharge: 'Top up',
    singleWalletNote: 'One wallet covers top-ups and all rewards; sources are labeled in the history.',
    historyTitle: 'History',
    historyDesc: 'Top-ups, rewards and pay-as-you-go charges.',
  ...
  rewardGift: {
    ...
    depositNote: 'Automatically deposited to your Wallet',
  ...
  adminOps: {
    ...
    highNearLimit: 'High / near limit',
    exhausted: 'Exhausted',
    paidToday: 'Paid today',
    fulfillmentIssues: 'Fulfillment issues',
    needsAttention: 'Needs attention',
    allClear: 'No issues need attention',
    attentionFulfillment: '{count} paid order(s) awaiting fulfillment',
    attentionResets: '{count} batch reset(s) with failed items',
    view: 'View',
    healthTitle: 'Subscription health (tier × status)',
    recentResets: 'Recent reset operations',
    goResetCenter: 'Open Reset Center',
    noResets: 'No reset operations yet',
    failedCount: '{count} failed',
    otherTier: 'Other tiers',
    targetMode: {
      subscription_ids: 'Selected subscriptions',
      users: 'Selected users',
      groups: 'Selected tiers',
      all_active: 'All active subscriptions',
    },
    b: {
      normal: 'Normal',
      high: 'High',
  ...
  user360: {
    ...
    collapse: 'Collapse',
    subDetails: 'Subscription detail (internal USD collapsed by default)',
    planChanges: 'Plan changes',
    noChanges: 'No plan changes',
    walletHistory: 'Recharge history',
    noHistory: 'No recharge history',
    cardHistory: 'Reset card history',
    noCards: 'No reset cards',
    keysTitle: 'API Keys (masked only)',
    noKeys: 'No API keys',
    ...
    resetConfirmOk: 'Reset now',
    resetQueued: 'Reset event created',
    cardGranted: '1 reset card granted',
    actionFailed: 'Action failed, please retry',
  },

  resetCenter: {
    title: 'Reset Center',
    directTab: 'Direct reset',
    cardsTab: 'Reset cards',
    directTitle: 'Direct reset — immediate',
    directDesc: 'Immediately resets the current period of target subscriptions to 0. Grants no reset card, touches no wallet, extends no plan. Preview first.',
    directConfirmNote: 'Executing will immediately reset the current period of the targets (effective now, not scheduled).',
    cardsTitle: 'Grant reset cards',
    cardsDesc: 'Granting does not reset anyone immediately; users decide when to use them.',
    targetMode: 'Target',
    reason: 'Reason (note)',
    reasonPlaceholder: 'Campaign / customer compensation…',
    userIds: 'User IDs',
    subIds: 'Subscription IDs',
    groupIds: 'Tier (group) IDs',
    perUser: 'Cards per user',
    expiresAt: 'Expires',
    campaign: 'Campaign',
    ...
    breakdown: 'By tier',
    cardPreviewLine: 'Matched users {users} · cards to grant {cards}',
    m: {
      users: 'Selected users',
      groups: 'Selected tiers',
      all_active: 'All active subscriptions',
      all_active_users: 'All matching users',
    },
    ...
    failed: 'Failed',
    execute: 'Execute',
    executed: 'Reset event created, running',
    ...
    grant: 'Grant',
    granted: 'Granted {count} reset card(s)',
    grantFailed: 'Grant failed',
    cardRecords: 'Reset card records',
    noCards: 'No records',
    userId: 'User',
    cardStatus: 'Status',
    actions: 'Actions',
    ...
    cardsNote: 'Reset cards do not take effect immediately; Available cards can be revoked, Used/Expired cannot.',
    previewFailed: 'Preview failed',
  },
  rewardCenter: {
    title: 'Reward Center',
    configTitle: 'Student verification reward',
    configDesc: 'Manages Reward → Wallet only; the student verification flow is out of scope.',
    enabled: 'Grant switch',
    enabledHint: 'When enabled, rewards are granted automatically once verification is approved.',
    amount: 'Reward amount (USD)',
    campaign: 'Campaign',
    noteAuto: 'Granted automatically upon approval — no manual steps.',
    noteIdempotent: 'One grant per user per campaign; never duplicated.',
    saved: 'Saved',
    saveFailed: 'Save failed',
    loadFailed: 'Failed to load configuration',
    recordsTitle: 'Grant records & statistics',
    userId: 'User',
    sourceType: 'Source',
    ...
    source: {
      student_verification: 'Student verification reward',
    ...
    recordsBlockedNote: 'The reward-records query endpoint is not available yet (logged in FRONTEND_BLOCKED_BY_API); statistics are pending.',
    previewNote: 'Preview of the user-facing reward gift card (static)',
  },
