    ...
    settings: {
      ...
      features: {
        ...
        webChat: {
          ...
          defaultModelHint: "Options come from rows below with type 'Chat' and 'API only' unchecked; you can also type a custom model ID.",
          modelsTitle: 'Model Configuration',
          modelsHint: 'Configure the models exposed through web chat. Candidates come from the available models of all groups; custom IDs are also allowed.',
          addModel: 'Add Model',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for MUC AI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for MUC AI end-user login',
      ...
      defaults: {
        ...
        studentVerificationRewardAmountUnit: 'Unit: CNY (wallet accounting currency)',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, MUC AI temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream MUC AI sites. Account rates change only when the separate sync switch is enabled.',
      ...
      payment: {
        ...
        minAmount: 'Minimum Amount (CNY)',
        maxAmount: 'Maximum Amount (CNY)',
        dailyLimit: 'Daily Limit (CNY)',
        balanceRechargeMultiplier: 'Balance Recharge Multiplier (fixed at 1)',
        balanceRechargeMultiplierHint: 'Wallet accounting is in CNY at a fixed 1:1 credit rate; USD payments convert at 1 USD = 6.7 CNY.',
        balanceRechargePreview: 'Fixed: 1 CNY = 1 CNY',
        usdToCnyDisplayRate: 'USD/CNY Display Conversion (fixed at 6.7)',
        usdToCnyDisplayRateHint:
          'Fixed at 1 USD = 6.7 CNY for the display toggle on USD-denominated model costs and provider prices; wallet balances and plan prices are stored in CNY.',
        usdToCnyDisplayRateDisabled: 'Disabled; display USD',
        subscriptionUsdToCnyRate: 'Subscription USD to CNY Rate',
        subscriptionUsdToCnyRateHint:
          'Retired. Subscription plans are priced and accounted for in CNY; keep this setting at 0.',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on MUC AI orders; the upstream type is sent as EasyPay type.',
