export default {
    settings: {
      ...
      payment: {
        ...
        usdToCnyDisplayRate: 'USD to CNY Display Rate',
        usdToCnyDisplayRateHint:
          'Display-only conversion for USD balances, usage, quotas, and model prices. It does not change billing or stored values. 0 or empty disables CNY display.',
