...
type PaymentOrder struct {
	...
	// PlanChangeID holds the value of the "plan_change_id" field.
	PlanChangeID *int64 `json:"plan_change_id,omitempty"`
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentorder.FieldID, paymentorder.FieldUserID, paymentorder.FieldPlanID, paymentorder.FieldSubscriptionGroupID, paymentorder.FieldSubscriptionDays, paymentorder.FieldPlanChangeID:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldPlanChangeID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field plan_change_id", values[i])
			} else if value.Valid {
				_m.PlanChangeID = new(int64)
				*_m.PlanChangeID = value.Int64
			}
		case paymentorder.FieldProviderSnapshot:
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.PlanChangeID; v != nil {
		builder.WriteString("plan_change_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
