...
func init() {
	...
	groupDescConcurrencyOverride := groupFields[16].Descriptor()
	...
	groupDescMusicPricePerTrack := groupFields[37].Descriptor()
	...
	usersubscriptionDescAutoPaygFallback := usersubscriptionFields[14].Descriptor()
