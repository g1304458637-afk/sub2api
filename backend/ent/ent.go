...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			researchapplication.Table:           researchapplication.ValidColumn,
			researchattachmentupload.Table:      researchattachmentupload.ValidColumn,
			securitysecret.Table:                securitysecret.ValidColumn,
			setting.Table:                       setting.ValidColumn,
			subscriptionplan.Table:              subscriptionplan.ValidColumn,
			subscriptionplanchange.Table:        subscriptionplanchange.ValidColumn,
			subscriptionresetapplication.Table:  subscriptionresetapplication.ValidColumn,
			subscriptionresetcard.Table:         subscriptionresetcard.ValidColumn,
			subscriptionresetevent.Table:        subscriptionresetevent.ValidColumn,
			subscriptionterm.Table:              subscriptionterm.ValidColumn,
