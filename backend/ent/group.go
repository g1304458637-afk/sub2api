...
type Group struct {
	...
	// QuotaPolicy holds the value of the "quota_policy" field.
	QuotaPolicy string `json:"quota_policy,omitempty"`
	// ShortLimitUsd holds the value of the "short_limit_usd" field.
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldRateMultiplier, group.FieldPeakRateMultiplier, group.FieldShortLimitUsd, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldMusicPricePerTrack, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer:
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldQuotaPolicy, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldQuotaPolicy:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field quota_policy", values[i])
			} else if value.Valid {
				_m.QuotaPolicy = value.String
			}
		case group.FieldShortLimitUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field short_limit_usd", values[i])
			} else if value.Valid {
				_m.ShortLimitUsd = new(float64)
				*_m.ShortLimitUsd = value.Float64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("quota_policy=")
	builder.WriteString(_m.QuotaPolicy)
	builder.WriteString(", ")
	if v := _m.ShortLimitUsd; v != nil {
		builder.WriteString("short_limit_usd=")
