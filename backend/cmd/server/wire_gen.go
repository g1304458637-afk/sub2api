...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionResetApplicationRepository := repository.NewSubscriptionResetApplicationRepository(client)
	subscriptionService := service.ProvideSubscriptionServiceWithReset(groupRepository, userSubscriptionRepository, billingCacheService, client, configConfig, subscriptionResetApplicationRepository)
	...
	adminService := service.NewAdminService(configConfig, userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, apiKeyService, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, channelService)
	...
	rewardGrantService := service.NewRewardGrantService(client, rewardGrantRepository, userRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService)
	adminRewardGrantHandler := admin.NewRewardGrantHandler(rewardGrantService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, adminResearchHandler, adminRewardGrantHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	musicTaskStore := repository.NewMusicTaskStore(redisClient)
	musicTaskService := service.ProvideMusicTaskService(musicTaskStore, imageStorageSettingService)
	asyncMusicHandler := handler.NewAsyncMusicHandler(musicTaskService, openAIGatewayHandler)
	...
	campusConnectHandlers := handler.ProvideCampusConnectHandlers(codeStore, apiKeyService, userService, gatewayService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, webChatHandler, asyncImageHandler, asyncMusicHandler, batchImageHandler, campusConnectHandlers, researchApplicationHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
