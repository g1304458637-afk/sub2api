...
func UserFromServiceAdmin(u *service.User) *AdminUser {
	...
	return &AdminUser{
		...
		EducationEmails:      u.EducationEmails,
	}
}
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		QuotaPolicy:                     g.QuotaPolicy,
		ShortLimitUSD:                   g.ShortLimitUSD,
...
func userSubscriptionFromServiceBase(sub *service.UserSubscription) UserSubscription {
	return UserSubscription{
		...
		ShortUsageUSD:      sub.ShortUsageUSD,
		ShortWindowStart:   sub.ShortWindowStart,
