...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		QuotaPolicy:                     source.QuotaPolicy,
		ShortLimitUSD:                   cloneGroupValuePointer(source.ShortLimitUSD),
		...
		MusicPricePerTrack:              cloneGroupValuePointer(source.MusicPricePerTrack),
