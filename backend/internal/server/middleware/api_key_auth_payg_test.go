...
func TestResetAndMusicReadRoutesRemainAvailableWithoutBalance(t *testing.T) {
	require.True(t, isSubscriptionResetRequest(http.MethodPost, "/muc/reset-with-card/1"))
	require.False(t, isSubscriptionResetRequest(http.MethodGet, "/muc/reset-with-card/1"))
